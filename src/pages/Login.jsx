...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      {panel === "admin" && (
        <p className="text-xs text-sky-800 mb-4 -mt-2 bg-sky-50 border border-sky-100 rounded-lg px-3 py-2">
          Demo admin login: <span className="font-mono">admin@givepulse.bd</span> / <span className="font-mono">admin123</span>
        </p>
      )}
      {panel === "user" && (
        <p className="text-xs text-crimson-900/50 mb-4 -mt-2 bg-crimson-50 rounded-lg px-3 py-2">
          Demo user login: <span className="font-mono">miraz@example.com</span> / <span className="font-mono">password</span>
        </p>
      )}
